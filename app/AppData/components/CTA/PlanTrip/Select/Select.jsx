...
export default function Select({datalist, placeholder, onData, isEmpty = false, iconValue}) {
    ...
    return (
        <div onClick={handleToggle} ref={selectBtnRef} className={styles.mainWrapper}>
            <div style={{borderColor: isDropdown ? "#1E2C70" : "", borderColor: isEmpty ? "#e00000" : ""}} className={styles.value}>
                ...
                <div className={isDropdown ? styles.dropedSvg : styles.dropSvg} ><IconList Icon={iconValue}/></div>
            </div>
