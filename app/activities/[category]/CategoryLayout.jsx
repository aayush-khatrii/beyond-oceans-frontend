...
export default function page({data, params}) {
    ...
    const [activityDatafilterd, setActivityDatafilterd] = useState(data.data)
    ...
    function paramData(){
        ...
        if (paramActivityType) {
            setFilterActivityType(ActivityTypeDL[paramActivityType]);
        }

        if(sortBy || filterBudget || filterActivityType){
            handleFilterSearch()
        }
    }
    ...
    const handleActivityType = (data) =>{
        setFilterActivityType(data)
    }

    function handleFilterSearch(){

        let filteredData = Array.isArray(activityData) ? [...activityData] : []
