...
export default function OTPPhone({phone, ctryCode, popupClose, onGoback}) {
    ...
    return (
        ...
        <Toaster richColors toastOptions={{ style: { fontFamily: "DM Sans",fontSize: "16px"}}}/>
            <div className={styles.OTPlable}>
                ...
                <span onClick={() => {handleGoBack("PHN")}}>{`+${ctryCode} ${phone}`} <span className={styles.editBtn}>Edit</span></span>
            </div>
            <div className={styles.subWrapper}>
                <OTPinput onOtpSubmit={onGetOtp} className={styles.otpBoxConts} />
