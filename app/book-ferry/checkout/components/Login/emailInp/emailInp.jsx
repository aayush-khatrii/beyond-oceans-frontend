    ...
    <div className={styles.mainWrapper}>
        ...
        <div className={styles.emailinputCont}>
            <div className={styles.inputBox}>
                <input autoFocus className={styles.EmailInp} style={{borderColor: isFalseEmail ? '#ff0000' : ''}} type="name" placeholder='Email Address' autoComplete='on' onChange={(e) => handleEmailChange(e)}/>
            </div>
        </div>
