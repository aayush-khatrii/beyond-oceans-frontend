...
import styles from './Diglipur.module.css'
...
export default function DiglipurLayout() {
  return (
    <div className={styles.mainWrapper}>
        <div className={styles.heroImage}>
            <div className={styles.heroTextSec}>
                <div className={styles.titleSec}>
                    <h1 className={styles.title}>Diglipur Island</h1>
                    <h1 className={styles.mobTitle}>Diglipur Island</h1>
                    <h2>Discovering Diglipur Island: A Pristine Paradise in Andaman and Nicobar</h2>
                </div>
                <div className={styles.breadcrumbSec}>
                    ...
                    <div className={styles.breadcrumbIcon}><IconList Icon="RightArrow"/></div>
                    <div><Link href="/destination/diglipur-island">Diglipur Island</Link></div>
                </div>
            </div>
