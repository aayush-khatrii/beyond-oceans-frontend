...
import styles from './Baratang.module.css'
...
export default function BaratangLayout() {
  return (
    <div className={styles.mainWrapper}>
        <div className={styles.heroImage}>
            <div className={styles.heroTextSec}>
                <div className={styles.titleSec}>
                    <h1 className={styles.title}>Baratang Island</h1>
                    <h1 className={styles.mobTitle}>Baratang Island</h1>
                    <h2>Exploring Baratang Island: A Hidden Gem in Andaman and Nicobar</h2>
                </div>
                <div className={styles.breadcrumbSec}>
                    ...
                    <div className={styles.breadcrumbIcon}><IconList Icon="RightArrow"/></div>
                    <div><Link href="/destination/baratang-island">Baratang Island</Link></div>
                </div>
            </div>
