        ...
        <div className={styles.activityLists}>
            <div className={styles.activityCard}>
                <div className={styles.imgWrapper}>
                    <Image
                        src="/assets/destination/activity/seawalking.webp"
                        fill={true}
                        sizes="100%"
                        priority={true}
            ...
            <div className={styles.activityCard}>
                <div className={styles.imgWrapper}>
                    <Image
                        src="/assets/destination/activity/scuba.webp"
                        fill={true}
                        sizes="100%"
                        priority={true}
                        style={{objectFit:"cover"}}
            ...
            <div className={styles.activityCard}>
                <div className={styles.imgWrapper}>
                    <Image
                        src="/assets/destination/activity/snorkelling.webp"
                        fill={true}
                        sizes="100%"
                        priority={true}
                        style={{objectFit:"cover"}}
            ...
            <div className={styles.activityCard}>
                <div className={styles.imgWrapper}>
                    <Image
                        src="/assets/destination/activity/parasailing.webp"
                        fill={true}
                        sizes="100%"
                        priority={true}
                        style={{objectFit:"cover"}}
