...
import styles from './LittleAndaman.module.css'
        ...
        <div className={styles.heroImage}>
            <div className={styles.heroTextSec}>
                <div className={styles.titleSec}>
                    <h1 className={styles.title}>Little Andaman</h1>
                    <h1 className={styles.mobTitle}>Little Andaman</h1>
                    <h2>Discovering Little Andaman Island: A Hidden Gem in the Andaman and Nicobar Archipelago</h2>
                </div>
                <div className={styles.breadcrumbSec}>
                    ...
                    <div className={styles.breadcrumbIcon}><IconList Icon="RightArrow"/></div>
                    <div><Link href="/destination/little-andaman">Little Andaman</Link></div>
                </div>
            </div>
