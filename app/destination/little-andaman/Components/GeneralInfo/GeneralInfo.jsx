    ...
    return (
        <div className={styles.mainWrapper} id='general-information'>
            <div className={styles.titleCont}>
                <h3>General Information About Little Andaman</h3>
            </div>
            <div className={styles.mainContent}>
                <ul>
                    ...
                    <li><span>Safety:</span>Little Andaman is generally safe for tourists. However, it’s important to follow local guidelines, respect the environment, and take necessary precautions during outdoor activities.</li>
                </ul>
            </div>
        </div>
    )
